...
class BetfairOdds:
    ...
    def __init__(self):
        ...
        self.list_of_market = []
        self.dict1 = {}
        header = {'X-Application': 'Y0yB2Zob0L0dSONJ', 'X-Authentication': session_token, 'Accept': 'application/json'}
        res = requests.post('https://identitysso.betfair.com/api/keepAlive',headers=header)
