...
class CricketCbuz:
        ...
        def full_news(self):
			...
			summarization_instance = ShortNews()
                        ...
                        try:
                                    news_dict.update({"website": "Cbuz_Cric_Feed", "summary":summarization_instance.summarization(full_text),\
					    ...
					    time.mktime(time.localtime())})
                                    ...
                                    news_dict.update({"website": "Cbuz_Cric_Feed", "summary":summary,"custom_summary": summary, "news":\
