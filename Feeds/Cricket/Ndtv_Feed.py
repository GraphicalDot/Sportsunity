        ...
        def full_news(self):
			...
			summarization_instance = ShortNews()
				...
				news_dict.update({"website": "www.sports.ndtv.com", "summary": summarization_instance.summarization(full_text),\
						...
						time.mktime(time.localtime()),'type':'cricket','favicon':'http://sports.ndtv.com/favicon.ico'})
                        except:
				news_dict.update({"website": "www.sports.ndtv.com", "summary":summary, "custom_summary":summary, "news": full_text,\
					...
					"time_of_storing": time.mktime(time.localtime()),'type':'cricket','favicon':'http://sports.ndtv.com/favicon.ico'})
