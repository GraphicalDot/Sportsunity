...
class CricketEspn:
        ...
        def full_news(self):
			...
			try:
				news_dict.update({"website": "www.espncricinfo.com", "summary": summarization_instance.summarization(full_text),\
						...
						'mdpi': all_formats_image['mdpi'],'hdpi': all_formats_image['hdpi'],"time_of_storing":\
                                                time.mktime(time.localtime()),'type':'cricket','favicon':'http://www.espncricinfo.com/favicon.ico'})
			except:
				news_dict.update({"website": "www.espncricinfo.com", "summary": summary,\
						"custom_summary":summary, "news": full_text, "image_link":image_link,'gmt_epoch':gmt_epoch,'publish_epoch':\
						publish_epoch, "day": day, "month": month, "year": year,'ldpi': all_formats_image['ldpi'],\
						'mdpi': all_formats_image['mdpi'],'hdpi': all_formats_image['hdpi'],"time_of_storing":\
                                                time.mktime(time.localtime()),'type':'cricket','favicon':'http://www.espncricinfo.com/favicon.ico'})
...
if __name__ == '__main__':
    obj = CricketEspn(ESPN_CRIC_FEED)
    obj.run()
