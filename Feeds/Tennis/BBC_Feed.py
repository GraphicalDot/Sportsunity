...
class TennisBbc:
        ...
        def full_news(self):
                ...
                for news_dict in self.links_not_present:
                        ...
                        try:
                                news_dict.update({"website": "bbci.co.uk", "summary": summarization_instance.summarization(full_text),'custom_summary':\
                                ...
                                news_dict.update({"website": "bbci.co.uk", "summary": summary,'custom_summary':summary, "news":\
