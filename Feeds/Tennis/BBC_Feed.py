...
class Tennis_BBC:
    ...
    def full_news(self):
        ...
        for val in self.list_of_links:
            ...
            _dict = {"website":"BBC_FEED","news_id":val,"summary":summary,"publish_date":publish_date,"news":full_text, "title":title,"image":image,"time_of_storing":time.mktime(time.localtime())}
