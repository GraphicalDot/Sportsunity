...
class TennFeedMongo(object):
        ...
        def if_news_exists(news_id, news_link):
                if news_collection_tenn.find_one({"news_id": news_id, "news_link": news_link}):
                        return True
        ...
        def insert_news(news_dict):
                news_collection_tenn.insert(news_dict)
                """
                bulk = news_collection_tenn.initialize_unordered_bulk_op()
