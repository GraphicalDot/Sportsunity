...
class Tennis_X:
    ...
    """
    def rss_feeds(self,TENNIS_X):
        list_of_links = list()
        self.list_of_links = list_of_links
        self.d = feedparser.parse(TENNIS_X)
    ...
    def full_news(self):
	    ...
	    _dict = {"website":"TENNIS_X","news_id":val,"summary":summary,"publish_date":publish_date,"news":full_text,"title":title,"image":image,"time_of_storing":time.mktime(time.localtime())}
