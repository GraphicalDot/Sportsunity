...
#from Links_Formula1 import Crash_dot_net
class Formula_one_Crash:
    ...
    def full_news(self):
	    ...
	    _dict = {"website":"Crash_dot_net", "news_id":val,"summary":summary,"publish_date":publish_date,"news":full_text,"title":title,"image":image, "time_of_Storing":time.mktime(time.localtime())}
