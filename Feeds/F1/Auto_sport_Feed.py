...
class Formula_one_Auto:
    ...
    def full_news(self):
        ...
        for val in self.list_of_links:
            ...
            _dict = {"website":"Auto_sport", "news_id":val,"summary":summary,"publish_date":publish_date,"news":full_text,"title":title,"image":image, "time_of_Storing":time.mktime(time.localtime())}
