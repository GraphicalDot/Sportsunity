...
class FormulaGrand:
        ...
        def full_news(self):
				...
				news_dict.update({"website": "www.grandprix.com", "summary": summarization_instance.summarization(full_text),\
						...
						'f1','favicon':'http://grandprix.com/favicon.ico'})
                        except:
					...
					all_formats_image['ldpi'],'mdpi': all_formats_image['mdpi'],'hdpi': all_formats_image['hdpi'],"time_of_storing":time.mktime(time.localtime()),'type':\
					'f1','favicon':'http://grandprix.com/favicon.ico'})
...
if __name__ == '__main__':
    obj = FormulaGrand(Grandprix_dot_com)
    obj.run()
