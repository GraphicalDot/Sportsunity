...
class CricketSportsunity:
        ...
        def __init__(self, link):
                ...
                [self.news_list.append({"news_link": news_entry["link"], "published": news_entry["date_gmt"], "summary": \
                        ...
                        "news_id": hashlib.md5(news_entry["link"]).hexdigest(), "image_link": news_entry['better_featured_image']['source_url'],\
        ...
        def full_news(self):
			...
			try:
						...
						'mdpi': all_formats_image['mdpi'],'hdpi': all_formats_image['hdpi'],"time_of_storing": time.mktime(time.localtime()),'type':\
                                                'cricket','favicon':'https://photos-6.dropbox.com/t/2/AAA31rURC_h5kcL4FbruNnvt2qJHj7-gaVc3rmYgmhfE2A/12/457047680/png/32x32/1/_/1/2/sportsunity-logo.png/EPiP9NgDGLkTIAcoBw/X2JQeT8v1r1yTNiwVBWgTPor9MJ9gfm3iHyPY4PUj_M?dl=0&size=2048x1536&size_mode=3'})
			except:
						...
						"custom_summary":news_dict['summary'], "news": news_dict['cleaned_text'], "image_link":\
                                                ...
                                                time.mktime(time.localtime()),'type':'cricket','favicon': 'https://photos-6.dropbox.com/t/2/AAA31rURC_h5kcL4FbruNnvt2qJHj7-gaVc3rmYgmhfE2A/12/457047680/png/32x32/1/_/1/2/sportsunity-logo.png/EPiP9NgDGLkTIAcoBw/X2JQeT8v1r1yTNiwVBWgTPor9MJ9gfm3iHyPY4PUj_M?dl=0&size=2048x1536&size_mode=3'})
...
if __name__ == '__main__':
    obj = CricketSportsunity(SPOUNI_CRIC_FEED)
    obj.run()
