...
class FootballFancast:
        ...
        def full_news(self):
                ...
                for news_dict in self.links_not_present:
						...
						time.mktime(time.localtime()),'sport_type':'football','favicon':'http://www.footballfancast.com/favicon.ico'})
                        except:
					...
					"time_of_storing": time.mktime(time.localtime()),'sport_type':'football','favicon':'http://www.footballfancast.com/favicon.ico'})
