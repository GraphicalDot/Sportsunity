			...
			try:
				...
				summary = None
                        ...
                        try: 
			                ...
			                news_dict.update({"website": "Goal_dot_com", "summary": summarization_instance.summarization(full_text),\
						...
						time.mktime(time.localtime())})
                                        ...
                                        news_dict.update({"website": "Goal_dot_com", "summary": summary, "custom_summary":summary, "news":\
