...
class PremArsenal:
        ...
        def full_news(self):
				...
				summary = None
                        ...
                        try:
                                news_dict.update({"website": "http://talksport.com","team":'Arsenal' ,"summary": summarization_instance.summarization(full_text),\
                                ...
                                news_dict.update({"website": "http://talksport.com","team":'Arsenal', "summary": summary, "custom_summary":summary, "news": full_text,\
