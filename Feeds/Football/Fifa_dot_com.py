...
#from Links_Football import Fifa_dot_com
class Football_Fifa:
    """
    ...
    def full_news(self):
        ...
        for val in self.list_of_links:
            ...
            _dict = {"website":"Fifa_dot_com","news_id":val,"summary":summary,"publish_date":publish_date,"news":full_text,"title":title,"image":image,"time_of_storing":time.mktime(time.localtime())}
