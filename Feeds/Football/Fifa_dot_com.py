...
class FootballFifa:
        ...
        def full_news(self):
				...
				summary = None
                        ...
                        try:
                                news_dict.update({"website": "Fifa_dot_com", "summary": summarization_instance.summarization(full_text),\
                                ...
                                news_dict.update({"website": "Fifa_dot_com", "summary": summary, "custom_summary":summary, "news": full_text,\
