...
class FootballUk:
        ...
        def full_news(self):
				...
				news_dict.update({"website": "www.football.co.uk", "summary": summarization_instance.summarization(full_text),\
						...
						time.mktime(time.localtime()),'type':'football','favicon':'http://www.football.co.uk/img/football-logo-new-small.png'})
                        except:
					...
					"time_of_storing": time.mktime(time.localtime()),'type':'football','favicon':'http://www.football.co.uk/img/football-logo-new-small.png'})
