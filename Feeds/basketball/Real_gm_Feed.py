...
class Basketball_Real:
    ...
    def full_news(self):
	    ...
	    if image.endswith(".jpg") or image.endswith(".png")==True:
            ...
            _dict = {"website":"Real_gm", "news_id":val,"publish_date":publish_date,"summary":summary,"news":full_text, "title":title, "image":image,'ldpi':all_formats_image['ldpi'],'mdpi':all_formats_image['mdpi'],'hdpi':all_formats_image['hdpi'],"time_of_storing":time.mktime(time.localtime())}
