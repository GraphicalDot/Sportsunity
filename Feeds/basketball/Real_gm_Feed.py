...
class BasketballReal:
        ...
        def full_news(self):
			...
			summarization_instance = ShortNews()
                        ...
                        try:
                                news_dict.update({"website": "www.basketball.realgm.com","summary":summarization_instance.summarization(full_text),\
						...
						time.mktime(time.localtime()),"type":"basketball",'favicon':'http://basketball.realgm.com/favicon.ico'})

                        except:
				news_dict.update({"website": "www.basketball.realgm.com","summary":summary, "custom_summary": summary, "news":\
						...
						"basketball", 'favicon':'http://basketball.realgm.com/favicon.ico'})
