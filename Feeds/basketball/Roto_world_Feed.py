...
class BasketballRoto(MainBasketBallFeedHandler):
    """
    ...
    def full_news(self):
        ...
        for news_dict in self.links_not_present:
            ...
            if published_news.endswith(("EDT", "GMT", "EST")):
                ...
                strp_time_object = time.strptime(published_news[:-6], "%Y-%m-%dT%H:%M:%S" )
            ...
            news_dict.update({
                ...
                "type":"basketball",
                'favicon':'http://www.rotoworld.com/favicon.ico'})
...
if __name__ == '__main__':
    obj = BasketballRoto(GlobalLinks.Roto_world).run()
