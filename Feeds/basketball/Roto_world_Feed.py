...
class BasketballRoto:
        ...
        def __init__(self, link):
                ...
                [self.news_list.append({"news_link": news_entry["link"], "published": news_entry["updated"], "summary": \
        ...
        def full_news(self):
                ...
                for news_dict in self.links_not_present:
                        ...
                        if news_dict['published'].endswith("EDT") or news_dict['published'].endswith("GMT"):
                                ...
                                strp_time_object = time.strptime(news_dict['published'][:-6], "%Y-%m-%dT%H:%M:%S" )
                        ...
                        news_dict.update({"website": "www.rotoworld.com","summary":summarization_instance.summarization(full_text) ,"custom_summary": summary, "news":\
                                full_text, "image_link":image_link,'publish_epoch': publish_epoch, "day": day, "month": month, "year": year, 
