...
class BasketballRoto:
        ...
        def full_news(self):
			...
			try:
				news_dict.update({"website": "www.rotoworld.com","summary":summarization_instance.summarization(full_text),\
				...
				news_dict.update({"website": "www.rotoworld.com","summary":summary, "custom_summary": summary, "news":\
						full_text, "image_link":image_link,'publish_epoch':publish_epoch, "day":day, "month":month, "year":\
